...
<body class="cv-body">
  <ul class="navbar-ul">
    ...
    <li class="navbar-li"><a class="active navbar-a" href="./browser.jsp">Search</a></li>
  </ul>
  ...
  <div class="browser-search">
    <div id="search-form" class="browser-search-column">
      <form action="#" method="post">
        ...
        <button class="cv-primaryButton browser-search-button" type="submit">Buscar</button>
      </form>
    </div>
    <div class="browser-search-column">
      <button onclick="showFilter()" class="cv-primaryButton browser-filter-button">Filtrar</button>
    </div>
  </div>
