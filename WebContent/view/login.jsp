  ...
  <div class="loginRow">
    ...
    <form id="loginForm" class="loginForm loginColumn loginRightColumn" action="login" method="post">
      <div class="loginImgContainer">
        <img src="${pageContext.request.contextPath}/img/logo.png" alt="Avatar" class="loginAvatar" />
      </div>
      ...
      <div class="loginContainer">
        <button id="loginButton" type="button" onclick="location.href='${pageContext.request.contextPath}/view/register.jsp';" class="cv-secondaryButton loginButton">
          REGISTER
        </button>
      </div>
    </form>
