	...
	<div class="loginRow">
		<div class="loginColumn loginLeftColumn loginInfocontainer">
			...
			<p>
				...
				<br /> Founded in 2003, the online site is a place for
				professionals
			</p>
		</div>
		<form id="loginForm" class="loginForm loginColumn loginRightColumn"
			action="<%= request.getContextPath() %>/registerUser" method="post">
			...
			<div class="loginContainer">
				...
				<button class="cv-primaryButton registerButton" id="registerButton"
					type="submit">REGISTER</button>
			</div>
			<div class="loginContainer">
				<button id="loginButton" type="button"
					onclick="location.href='./login.jsp';"
					class="cv-secondaryButton loginButton">LOGIN</button>
			</div>
		</form>
	</div>
</body>
